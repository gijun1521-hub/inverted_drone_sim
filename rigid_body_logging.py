...
FIELDS = [
    ...
    "damping_moment",
    "moving_mass_moment",
    "legacy_moving_mass_moment",
    "thrust_moment_from_com_offset",
    "vane_moment_about_total_com",
    "total_com_body_right_m",
    "total_com_body_up_m",
    "thrust_application_arm_body_right_m",
    "thrust_application_arm_body_up_m",
    "vane_application_arm_body_right_m",
    "vane_application_arm_body_up_m",
    "total_com_geometry_active",
    "total_moment",
    "moving_mass_offset_m",
    "moving_mass_velocity_m_s",
    "moving_mass_target_m",
    "moving_mass_command_m",
    "moving_mass_saturated",
    "moving_mass_command_clipped",
    "moving_mass_rail_contact",
    "moving_mass_rate_limited",
    "moving_mass_acceleration_limited",
    "x_ddot",
    "z_ddot",
    "theta_ddot",
    "desired_moment",
...
def make_rigid_body_row(
    ...
    return {
        ...
        "thrust_moment": float(forces.thrust_moment),
        ...
        "thrust_application_arm_body_right_m": float(forces.thrust_application_arm_body_right_m),
        "thrust_application_arm_body_up_m": float(forces.thrust_application_arm_body_up_m),
        "vane_application_arm_body_right_m": float(forces.vane_application_arm_body_right_m),
        "vane_application_arm_body_up_m": float(forces.vane_application_arm_body_up_m),
