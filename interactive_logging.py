...
INTERACTIVE_FIELDS = [
    ...
    "desired_moment",
    "achievable_moment",
    "physically_achievable_moment",
    "unattainable_moment",
    "anti_windup_correction",
    "integrator_inhibited",
    "thrust_cmd",
    "vane_angle_cmd",
    "thrust_force_x",
    "thrust_force_z",
    ...
    "mixer_saturated",
    "mixer_angle_saturated",
    "mixer_authority_limited",
    "crash_reason",
    "min_body_z",
    "physics_dt",
    "controller_dt",
...
def interactive_row(
    ...
    return {
        ...
        "integrator_inhibited": int(control.integrator_inhibited),
        ...
        "mixer_angle_saturated": int(control.mixer.angle_saturated),
