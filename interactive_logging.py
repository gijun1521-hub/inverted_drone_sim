...
INTERACTIVE_FIELDS = [
    ...
    "vane_moment", "damping_moment", "total_moment", "motor_saturated", "servo_angle_saturated",
...
def interactive_row(
    ...
    row = {
        ...
        "total_moment": float(forces.total_moment), "motor_saturated": int(motor.saturated),
